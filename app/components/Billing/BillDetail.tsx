  ...
  return (
    <div id="pdf-content" className="w-[794px] text-[16px] text-darkPurple">
      <div className="flex h-fit w-[98%] flex-col">
        <div className="flex min-h-[124px] w-full items-center justify-between">
          <Image
            alt=""
            src={GPLogo}
        ...
        <div className="flex min-h-[1000px] flex-col items-start justify-center gap-2 px-8 py-4">
          ...
          <p>
            ...
            {allCandidates.length} candidatos y destacando los{" "}
            {selectedCvs.length} con mayor ajuste técnico, experiencia y
            compatibilidad con el perfil solicitado.
          </p>
        </div>

        <div className="flex min-h-[1124px] flex-col gap-10 px-8">
          <p className="text-[24px] font-[600]">1. Resumen ejecutivo</p>

          {/*GRID*/}
          <div className="grid w-full grid-cols-2 grid-rows-8 px-10 pb-10 pt-1">
            <p className="w-full place-self-start border bg-darkPurple px-4 pb-4 text-white">
            ...
            <p className="w-full place-self-start border px-4 pb-4">
              {" "}
              {
                allCandidates.filter(
                  (cv) =>
                    cv.recommendation == "Apto" && selectedCvs.includes(cv.id),
                ).length
              }{" "}
            </p>
            ...
            <div className="w-full border bg-darkPurple px-4 py-1 text-white">
